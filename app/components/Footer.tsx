        ...
        <footer className="bg-[var(--surface)] py-10 px-8 mt-12 border-t border-[var(--border)]">
            <div className="max-w-[1280px] mx-auto">
                <div className="flex items-center gap-3 mb-1">
                    ...
                    <span className="text-base font-bold tracking-wide text-[var(--text-main)]">SKadamboev.</span>
                </div>
                <div className="font-mono text-[11px] tracking-[0.14em] uppercase text-[var(--text-muted)] mb-5">
                    Engineering Reliable Systems
                </div>

                <div className="font-mono text-[10px] tracking-[0.18em] uppercase text-[var(--gray)] mb-2">
                    Connect
                </div>
                <div className="flex flex-wrap gap-x-6 gap-y-2 font-mono text-xs mb-8 text-[var(--light-blue)]">
                    <a
                ...
                <div className="flex justify-between flex-wrap gap-3 font-mono text-[10.5px] text-[var(--gray)] border-t border-[var(--border)] pt-5">
