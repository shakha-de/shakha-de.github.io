                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-20">
                            {categories.map((cat, i) => (
                                <FadeIn key={i} delay={i * 0.1}>
                                    <div className="flex flex-col gap-6 p-8 rounded-3xl bg-background border border-border shadow-sm h-full">
                            ...
                            <div className="flex flex-wrap gap-3">
                                {skills.all.map((skill, i) => (
                                    <FadeIn key={i} delay={0.3 + i * 0.05}>
                                        <span className="px-5 py-2.5 bg-primary/5 text-primary border border-primary/20 rounded-full text-sm font-bold">
                                            {skill}
                                        </span>
                                    </FadeIn>
                                ))}
                            ...
                            <div className="space-y-4">
                                {awards.map((award, i) => (
                                    <FadeIn key={i} delay={0.5 + i * 0.1}>
                                        <div className="flex items-start gap-4 p-6 rounded-2xl bg-yellow-500/5 border border-yellow-500/20 text-text-main">
