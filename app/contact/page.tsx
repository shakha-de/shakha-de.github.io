            ...
            <main className="grow flex flex-col items-center justify-center w-full app-container section-stack">
                <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                    <div>
                        ...
                        <p className="text-text-muted text-base sm:text-lg lg:text-xl mb-10 sm:mb-12 max-w-lg">
                        ...
                        <div className="flex flex-col gap-4 sm:gap-6">
                            {contactMethods.map((method, i) => (
                                <a
                                    key={i}
                                    href={method.link}
                                    className="flex items-center gap-4 text-text-main hover:text-primary transition-all group rounded-2xl p-3 -m-3"
                                    target={method.link.startsWith("http") ? "_blank" : undefined}
                                    rel={method.link.startsWith("http") ? "noopener noreferrer" : undefined}
                                >
                                    <div className="size-12 sm:size-14 bg-surface rounded-2xl flex items-center justify-center border border-border group-hover:border-primary group-hover:bg-primary/5 transition-all shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-base sm:text-lg font-bold break-all sm:break-normal">{method.value}</p>
                                    </div>
                                </a>
                            ))}
                        </div>
                    ...
                    <div className="relative p-6 sm:p-8 lg:p-12 rounded-4xl sm:rounded-[2.5rem] bg-surface border border-border overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex items-center gap-3 text-base sm:text-lg font-medium text-text-main mb-6 sm:mb-8">
