                ...
                <section className="app-container section-stack w-full">
                    <div className="w-full max-w-4xl">
                        <FadeIn delay={0.1}>
                            ...
                            <p className="body-text text-base sm:text-lg md:text-xl leading-relaxed max-w-[680px] text-[#c9ccd1] mb-12">
                        ...
                        <div className="contact-grid grid grid-cols-1 lg:grid-cols-2 gap-16 mt-14 max-w-[1080px]">
                            <FadeIn delay={0.2}>
                                <div className="contact-channels flex flex-col gap-5">
                                    ...
                                    >
                                        ...
                                        <span className="text-[var(--off-white)]">{personalInfo.email}</span>
                                    </a>
                                    <a
                                        className="channel-link"
                                    ...
                                    >
                                        <span className="text-[var(--nous-blue)] w-[18px]">↗</span>
                                        <span className="text-[var(--off-white)]">linkedin.com/in/shakhade</span>
                                    </a>
                                    <a
                                        className="channel-link"
                                    ...
                                    >
                                        <span className="text-[var(--nous-blue)] w-[18px]">⟨⟩</span>
                                        <span className="text-[var(--off-white)]">github.com/shakha-de</span>
                                    </a>
                                    <div className="channel-link cursor-default">
                                        <span className="text-[var(--nous-blue)] w-[18px]">◉</span>
                                        <span className="text-[var(--off-white)]">Halle (Saale), Germany</span>
                                    </div>
                                </div>
                            </FadeIn>
                            ...
                            <FadeIn delay={0.3}>
                                <div>
                                    <div className="sg-title font-mono text-xs tracking-[0.12em] uppercase text-[var(--off-white)] mb-[18px]">
                                        {"// Languages"}
                                    </div>
                                    <div className="langs font-mono text-[13px] text-[var(--gray)] leading-[2.1]">
                                        {personalInfo.languages.map((lang, idx) => (
                                            <span key={lang.language}>
                                                <strong className="text-[var(--off-white)] font-normal">{lang.language}</strong> — {lang.proficiency}
