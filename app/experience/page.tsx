            ...
            <main className="grow flex flex-col items-center w-full px-4 md:px-10 lg:px-40 py-20 max-w-[1440px] mx-auto">
                <div className="w-full max-w-4xl">
                    <section className="mb-20">
                        ...
                        <div className="relative border-l-2 border-border-light dark:border-zinc-700 ml-3 md:ml-6 space-y-12 pb-4">
                            {experience.map((exp, i) => (
                                <div key={i} className="relative pl-8 md:pl-12">
                                    <div className="absolute -left-2.25 top-1.5 size-4.5 rounded-full bg-white dark:bg-zinc-900 border-2 border-primary timeline-node shadow-sm"></div>
                                    ...
                                    <h4 className="text-base font-medium text-text-muted mb-3 flex items-center gap-2">
                                        ...
                                        {exp.location && (
                                            <>
                                                <span className="text-border-light dark:text-zinc-700">•</span>
                    ...
                    <section>
                        ...
                        <div className="space-y-8">
                            {education.map((edu, i) => (
                                <div key={i} className="p-8 rounded-2xl bg-white dark:bg-zinc-900 border border-border-light dark:border-zinc-700 shadow-sm">
                                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                                        ...
                                        <span className="text-sm font-mono text-text-muted bg-gray-100 dark:bg-zinc-800 px-3 py-1 rounded-md self-start">
                                            {edu.period}
                                        </span>
                                    </div>
                                    <div className="mt-4">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {edu.coursework.map((course, j) => (
                                                <span key={j} className="text-sm bg-gray-50 dark:bg-zinc-800/50 text-text-muted px-2 py-1 rounded border border-border-light dark:border-zinc-700/50">
                                                    {course}
                                                </span>
                                            ))}
                                        </div>
